package com.example.pnjutstihilmiyatul_asna
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnLogin.setOnClickListener {
            ...
            Log.d("TAG", edtPass.text.toString())
            if (edtUname.text.toString().equals("hilmi@gmail.com") && edtPass.text.toString()
                    .equals("1234")
            ) {
                val data = getSharedPreferences("Profile", Context.MODE_PRIVATE)
                val edit = data.edit()
                edit.putString("email", "hilmi@gmail.com")
                edit.putString("nim", "2207411001")
                edit.putString("nama", "hilmi")
